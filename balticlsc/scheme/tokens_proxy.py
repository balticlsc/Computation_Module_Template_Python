...
from balticlsc.scheme.utils import snake_dict_to_camel_dict
...
class TokensProxy:
    ...
    def send_output_token(self, pin_name: str, values: str, msg_id: str, is_final: bool) -> HTTPStatus:
        output_token = OutputTokenMessage(pin_name, self.__sender_uid, values, msg_id, is_final)
        return HTTPStatus(requests.post(self.__batch_manager_token_url,
    ...
    def send_ack_token(self, msg_ids: [], is_final: bool, is_failed: bool = False, note: str = None) -> HTTPStatus:
        ...
        return HTTPStatus(requests.post(self.__batch_manager_ack_url,
