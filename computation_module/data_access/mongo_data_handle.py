...
class MongoDBHandle(DataHandle):
    ...
    def __init__(self, pin_name: str, pins_configuration: []):
        ...
        self.__connection_string = 'mongodb://' + self._pin_configuration.AccessCredential['User'] + ':' \
                                   + self._pin_configuration.AccessCredential['Password'] + '@' \
                                   + self._pin_configuration.AccessCredential['Host'] + ':' \
                                   + self._pin_configuration.AccessCredential['Port']
